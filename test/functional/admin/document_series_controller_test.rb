...
class Admin::DocumentSeriesControllerTest < ActionController::TestCase
  ...
  view_test 'GET #documents lists the documents in the series' do
    doc1 = create(:published_publication)
    doc2 = create(:published_publication)
    document_series = create(:document_series, organisation: @organisation, documents: [doc1.document, doc2.document])

    get :documents, organisation_id: @organisation, id: document_series
